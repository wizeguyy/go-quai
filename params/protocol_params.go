...
var (
	...
	GardenDurationLimit           = big.NewInt(12)     // The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.
	...
	LocalDurationLimit            = big.NewInt(12)     // The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.
